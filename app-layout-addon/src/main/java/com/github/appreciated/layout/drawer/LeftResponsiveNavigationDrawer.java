...
public class LeftResponsiveNavigationDrawer extends AbstractNavigationDrawer {

    public LeftResponsiveNavigationDrawer() throws IOException {
        super("responsive-left-navigation-drawer.html");
    }
