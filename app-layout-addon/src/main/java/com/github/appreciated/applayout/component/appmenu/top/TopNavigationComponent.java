...
import com.github.appreciated.applayout.webcomponents.papertabs.PaperTab;
...
public class TopNavigationComponent extends PaperTab implements NavigationElementContainer {
    ...
    /**
     * The respective view behind this menu element (either {@link TopNavigationComponent#view} or {@link TopNavigationComponent#className} will be initialized)
     */
    ...
    public TopNavigationComponent(String caption, Icon icon) {
        super(caption, icon, null);
    ...
    public TopNavigationComponent(String caption, String route, Icon icon, Component view) {
    ...
    public TopNavigationComponent(String caption, Icon icon, DefaultBadgeHolder badgeHolder, Class<? extends Component> className) {
        this(caption, null, icon, className);
    }

    public TopNavigationComponent(Icon icon, Class<? extends Component> className) {
        this(null, null, icon, className);
    }

    public TopNavigationComponent(Icon icon, DefaultBadgeHolder badgeHolder, Class<? extends Component> className) {
        this(null, null, icon, className);
    }

    public TopNavigationComponent(String caption, String route, Icon icon, Class<? extends Component> className) {
        super(caption, icon, buttonClickEvent -> {
