...
/**
 * The interface every {@link Behaviour} is required to be implemented to allow any {@link com.github.appreciated.app.layout.builder.AppLayoutBuilder} to build it.
 */
