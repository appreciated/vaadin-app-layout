...
/**
 * FIXME: JavaDoc is missleading.
 * First use @link for references.
 * 
 * When you say "... basic implementation of the Navigator.."
 * would me lead (as Vaadin user) to think this is an implementation (subclass) of Vaadin Navigator. But it isn't.
 * 
 * Proposal:
 * 
