...
public class AbstractViewInfoProducer implements AppLayoutConfiguration.NavigationElementInfoProducer {
  ...
  private AnnotationValueProvider<String> captionProvider = info -> info.getAnnotation(Caption.class) == null
                                                                    ? null
                                                                    : info.getAnnotation(Caption.class).value();
  private AnnotationValueProvider<Icon> iconProvider = info -> info.getAnnotation(com.github.appreciated.app.layout.annotations.Icon.class) == null
                                                               ? null
                                                               : info.getAnnotation(com.github.appreciated.app.layout.annotations.Icon.class).value().create();
