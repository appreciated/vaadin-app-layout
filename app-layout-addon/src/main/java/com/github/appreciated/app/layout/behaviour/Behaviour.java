...
public enum Behaviour {
     ...
     * To allow content to be shown better the menu will be collapsed at a certain width range to a smaller in between state before it will be hidden completly.
     * The {@link com.github.appreciated.app.layout.webcomponents.applayout.AppDrawer} is positioned on the left. If the {@link com.github.appreciated.app.layout.webcomponents.applayout.AppToolbar} is visible it will be shown beside on the right of the {@link com.github.appreciated.app.layout.webcomponents.appmenu.AppMenu}.
     * The {@link com.github.appreciated.app.layout.webcomponents.applayout.AppToolbar} will be hidden unless a certain device width is surpassed to allow to show the button to show the menu.
     */
     ...
     * An instance of the following {@link Behaviour} can be collapsed manually with the burger button if a certain browser width is surpassed (f.e. most mobile devices) otherwise the menu will always visible.
     * To allow content to be shown better the menu will be collapsed at a certain width range to a smaller in between state before it will be hidden completly.
     * The {@link com.github.appreciated.app.layout.webcomponents.applayout.AppDrawer} is positioned on the left. The {@link com.github.appreciated.app.layout.webcomponents.applayout.AppToolbar} will be shown beside on the right of the {@link com.github.appreciated.app.layout.webcomponents.appmenu.AppMenu}.
     */
    ...
    /**
     * An instance of the following {@link Behaviour} can will not be collaped if shown on smaller devices. The menu elements will be shown inside the {@link com.github.appreciated.app.layout.webcomponents.applayout.AppToolbar} beside other elements added to it. This should
     * only be used if you only a few enu entries.
     */
    TOP(Top.class, true, true, false, false),

    /**
     * An instance of the following {@link Behaviour} can will not be collaped if shown on smaller devices. The menu elements will be shown inside the {@link com.github.appreciated.app.layout.webcomponents.applayout.AppToolbar} below other elements added to it. This should
     * only be used if you only a few enu entries.
     */
