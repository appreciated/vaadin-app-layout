...
public enum Behaviour {
    ...
    LEFT_RESPONSIVE_HYBRID_NO_APP_BAR(LeftResponsiveHybridOverlayNoAppBar.class, true, false, false),
    LEFT_RESPONSIVE_HYBRID_OVERLAY_NO_APP_BAR(LeftResponsiveHybridNoAppBar.class, true, false, false),
