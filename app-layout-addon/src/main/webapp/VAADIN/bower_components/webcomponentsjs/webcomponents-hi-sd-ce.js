...
*/
    'use strict';
    var J = "undefined" != typeof window && window === this ? this : "undefined" != typeof global && null != global ? global : this,
        Aa = "function" == typeof Object.defineProperties ? Object.defineProperty : function (g, q, N) {
    ...
    function ed() {
        ...
        "function" != typeof Array.prototype[g] && Aa(Array.prototype, g, {
            configurable: !0,
            writable: !0,
            value: function () {
                return fd(this)
    ...
    (function () {
        ...
        function jd(a) {
            ...
            vb && x(Element.prototype, "attachShadow", function (a) {
                return this.__CE_shadowRoot = a = vb.call(this, a)
            });
            if (Ca && Ca.get) b(Element.prototype, Ca); else if (Da && Da.get) b(HTMLElement.prototype, Da); else {
                    ...
                    b(a, {
                        enumerable: !0, configurable: !0, get: function () {
                            ...
                            var b = "template" === this.localName ?
                                this.content : this;
                            for (d.innerHTML = a; 0 < b.childNodes.length;) Fa.call(b, b.childNodes[0]);
            ...
            Bb ? c(HTMLElement.prototype, Bb) : Cb ? c(Element.prototype,
                Cb) : console.warn("Custom Elements: `Element#insertAdjacentElement` was not patched.");
            Ha(a, Element.prototype, {Z: kd, append: ld});
            md(a, {ja: nd, Wa: od, replaceWith: pd, remove: qd})
        }
        ...
        function md(a, b) {
            ...
            void 0 !== b.replaceWith && x(c, "replaceWith", function (c) {
                ...
                if (w) for (a.a(this), d = 0; d < e.length; d++) h = e[d], h instanceof Element && a.b(h)
            });
        ...
        function rd(a) {
            ...
            x(Node.prototype, "replaceChild", function (b, d) {
                ...
                c = t(b);
                var f = Eb.call(this, b, d), k = t(this);
                k && a.a(d);
                c && a.a(b);
                k && a.b(b);
                return f
            });
            Ia && Ia.get ? b(Node.prototype, Ia) : a.s(function (a) {
                b(a, {
                    enumerable: !0, configurable: !0, get: function () {
        ...
        function sd(a) {
            ...
            Ha(a, Document.prototype, {Z: vd, append: wd})
        }
        ...
        function xd(a) {
            window.HTMLElement = function () {
                function b() {
                    ...
                    if (0 === e.length) return e = Ea.call(document, d.localName), Object.setPrototypeOf(e, b.prototype), e.__CE_state = 1, e.__CE_definition = d, a.g(e), e;
                    d = e.length - 1;
                    var f = e[d];
                    if (f === Fb) throw Error("The HTMLElement constructor was either called reentrantly for this constructor or called multiple times.");
                    e[d] = Fb;
        ...
        function ka(a) {
            if (!a.__shady || void 0 === a.__shady.firstChild) {
                ...
                Ib(a);
                for (var b = a.__shady.childNodes = S(a), c = 0, d; c < b.length && (d = b[c]); c++) d.__shady = d.__shady || {}, d.__shady.parentNode = a, d.__shady.nextSibling = b[c + 1] || null, d.__shady.previousSibling = b[c - 1] || null, Jb(d)
            }
        }

        function zd(a) {
            var b = a && a.M;
            b && (b.X.delete(a.Ra), b.X.size || (a.Sa.__shady.S = null))
        }

        function Ad(a, b) {
            a.__shady = a.__shady || {};
            a.__shady.S || (a.__shady.S = new la);
            a.__shady.S.X.add(b);
            var c = a.__shady.S;
            return {
                Ra: b, M: c, Sa: a, takeRecords: function () {
                ...
                a:{
                    ...
                    switch (h.nodeType) {
                        case Node.ELEMENT_NODE:
                            for (var m = h.localName, l = "<" + m, q = h.attributes, n = 0; w = q[n]; n++) l += " " + w.name + '="' + w.value.replace(Dd, Ob) + '"';
                            l += ">";
                            h = Ed[m] ? l : l + Ra(h, g) + "</" + m + ">";
                            break a;
                        case Node.TEXT_NODE:
                            h = h.data;
                            h = w && Fd[w.localName] ? h : h.replace(Gd, Ob);
                            break a;
        ...
        function Ua(a, b, c) {
            ...
            if (c) {
                ...
                if (void 0 !== d &&
                    d !== a || void 0 === d && U(c) !== a) throw Error("Failed to execute 'insertBefore' on 'Node': The node before which the new node is to be inserted is not a child of this node.");
            }
            if (c === b) return b;
            ...
            k || (k = G(a) ? a.host : a, c ? (c = bc(c), Xa.call(k, b, c)) : cc.call(k, b));
            dc(a, b);
            return b
        }
        ...
        function Va(a, b) {
            ...
            ec(b);
            c && ((e = a && "slot" === a.localName) && (f = !0), ((d = c.Ta(b)) || e) && c.L());
            f || (f = G(a) ? a.host : a, (!a.__shady.root && "slot" !== b.localName || f === U(b)) && ba.call(f, b));
            dc(a, null, b);
            return b
        }

        function ec(a) {
            if (a.__shady && void 0 !== a.__shady.ma) for (var b = a.childNodes, c = 0, d = b.length, e; c < d && (e = b[c]); c++) ec(e);
            a.__shady && (a.__shady.ma = void 0)
        }

        function bc(a) {
            var b = a;
            a && "slot" === a.localName && (b = (b = a.__shady && a.__shady.P) && b.length ? b[0] : bc(a.nextSibling));
            return b
        }

        function Wa(a) {
            return (a =
                a && a.__shady && a.__shady.root) && a.ta()
        }

        function fc(a, b) {
            "slot" === b ? (a = a.parentNode, Wa(a) && a.__shady.root.L()) : "slot" === a.localName && "name" === b && (b = Z(a)) && (b.Va(a), b.L())
        }

        function dc(a, b, c) {
            if (a = a.__shady && a.__shady.S) b && a.addedNodes.push(b), c && a.removedNodes.push(c), a.ib()
        }
        ...
        function gc(a) {
            if (a && a.nodeType) {
                a.__shady = a.__shady || {};
                var b = a.__shady.ma;
                void 0 === b && (G(a) ? b = a : b = (b = a.parentNode) ? gc(b) : a, ca.call(document.documentElement, a) && (a.__shady.ma = b));
                return b
            }
        }
        ...
        function jc(a, b, c) {
            ...
            oa && "class" === b ? oa.setElementClass(a, c) : (kc.call(a, b, c), fc(a, b))
        }

        function lc(a, b) {
            if (a.ownerDocument !== document) return Ya.call(document, a, b);
            var c = Ya.call(document,
                a, !1);
            if (b) {
                a = a.childNodes;
                b = 0;
        ...
        function mc(a, b) {
            if (!G) return a;
            a = Za(a, !0);
            for (var c = 0, d, e, f, k; c < b.length; c++) if (d = b[c], f = d === window ? window : d.getRootNode(), f !== e && (k = a.indexOf(f), e = f), !G(f) ||
                -1 < k) return d
        }
        ...
        function nc(a, b, c) {
            if (c = b.__handlers && b.__handlers[a.type] && b.__handlers[a.type][c]) for (var d = 0, e; (e = c[d]) && a.target !== a.relatedTarget && (e.call(b, a), !a.Ka); d++) ;
        }
        ...
        function Hd(a) {
            ...
            for (c = 0; c < b.length; c++) {
                ...
                if (0 === c || f && f === e) if (nc(a, d, "bubble"), d !== window && (e = d.getRootNode()), a.fa) break
            }
        }

        function oc(a, b, c, d, e, f) {
            for (var k = 0; k < a.length; k++) {
                var h = a[k], w = h.type, g = h.capture, m = h.once, l = h.passive;
        ...
        function pc(a, b, c) {
            if (b) {
                ...
                b[da].push({node: this, type: a, capture: d, once: e, passive: f, mb: h});
                ab[a] ? (this.__handlers = this.__handlers || {}, this.__handlers[a] = this.__handlers[a] || {
                    capture: [],
                    bubble: []
                }, this.__handlers[a][d ? "capture" : "bubble"].push(h)) : (this instanceof Window ? rc : sc).call(this, a, h, c)
            }
        }
        ...
        function tc(a, b, c) {
            if (b) {
                ...
                var k = c && c.ga || this, h = void 0;
                var g = null;
                try {
                    g = b[da]
                } catch (r) {
                }
                g && (e = oc(g, k, a, d, e, f), -1 < e && (h = g.splice(e, 1)[0].mb, g.length || (b[da] = void 0)));
                (this instanceof Window ? uc : vc).call(this, a, h || b, c);
                h && ab[a] && this.__handlers && this.__handlers[a] && (a = this.__handlers[a][d ? "capture" : "bubble"], h = a.indexOf(h), -1 < h && a.splice(h, 1))
            }
        }

        function Id() {
            for (var a in ab) window.addEventListener(a, function (a) {
                a.__target || (qc(a), Hd(a))
            }, !0)
        }
        ...
        function qc(a) {
            ...
            a.ra =
                a.relatedTarget;
            if (E.R) {
                var b = wc, c = Object.getPrototypeOf(a);
        ...
        function Jd(a, b, c, d) {
            ...
            if (b == a.length && d == c.length) {
                h = a.length;
                for (var r = c.length, m = 0; m < g - k && Kd(a[--h], c[--r]);) m++;
                h = m
            }
            e += k;
            f += k;
            ...
            for (r = 1; r < d; r++) for (m = 1; m < h; m++) if (a[g + m - 1] === c[k + r - 1]) b[r][m] = b[r - 1][m - 1]; else {
                var l = b[r - 1][m] + 1, n = b[r][m - 1] + 1;
                b[r][m] = l < n ? l : n
            }
            g = b.length - 1;
            k = b[0].length - 1;
            d = b[g][k];
            for (a = []; 0 < g || 0 < k;) 0 == g ? (a.push(2), k--) : 0 == k ? (a.push(3), g--) : (h = b[g - 1][k - 1], r = b[g - 1][k], m = b[g][k - 1], l = r < m ? r < h ? r : h : m < h ? m : h, l == h ? (h == d ? a.push(0) : (a.push(1),
                d = h), g--, k--) : l == r ? (a.push(3), g--, d = r) : (a.push(2), k--, d = m));
            a.reverse();
            b = void 0;
            g = [];
        ...
        function Ld() {
            ...
            L(window.Node.prototype, Md);
            L(window.Window.prototype, Nd);
            L(window.Text.prototype, Od);
            ...
            window.HTMLSlotElement && L(window.HTMLSlotElement.prototype,
                Bc);
            L(a.prototype, Pd);
            E.R && (P(window.Node.prototype), P(window.Text.prototype), P(window.DocumentFragment.prototype), P(window.Element.prototype), P(a.prototype), P(window.Document.prototype), window.HTMLSlotElement && P(window.HTMLSlotElement.prototype))
        }
        ...
        function O(a, b, c) {
            ...
            for (var d = a; d;) {
                if (d.nodeType === Node.ELEMENT_NODE) {
                    ...
                    if (e =
                            e.__CE_shadowRoot) for (e = e.firstChild; e; e = e.nextSibling) O(e, b, c)
                }
        ...
        function db(a) {
            a = a.replace(F.Za, "").replace(F.port, "");
            var b = Dc, c = a, d = new Ba;
            d.start = 0;
            d.end = c.length;
        ...
        function Dc(a, b) {
            ...
            a.parent && (c = b.substring(a.previous ? a.previous.end : a.parent.start, a.start - 1), c = Rd(c), c = c.replace(F.Ba, " "), c = c.substring(c.lastIndexOf(";") + 1), c = a.parsedSelector = a.selector = c.trim(), a.atRule = 0 === c.indexOf("@"), a.atRule ? 0 === c.indexOf("@media") ? a.type = I.MEDIA_RULE : c.match(F.eb) && (a.type = I.da, a.keyframesName = a.selector.split(F.Ba).pop()) : a.type = 0 === c.indexOf("--") ? I.na : I.STYLE_RULE);
            if (c = a.rules) for (var d = 0, e = c.length, f; d < e && (f = c[d]); d++) Dc(f, b);
            return a
        }
        ...
        function Ec(a, b, c) {
            ...
            if (a.cssText || a.rules) {
                ...
                } else b ? b = a.cssText : (b = a.cssText, b = b.replace(F.wa, "").replace(F.Aa, ""), b = b.replace(F.fb, "").replace(F.kb, "")), (d = b.trim()) && (d = "  " + d + "\n")
            }
        ...
        function Fc(a) {
            A =
                a && a.shimcssproperties ? !1 : z || !(navigator.userAgent.match(/AppleWebKit\/601|Edge\/15/) || !window.CSS || !CSS.supports || !CSS.supports("box-shadow", "0 0 0 var(--foo)"))
        }
        ...
        function W(a, b, c, d) {
            if (a) {
                var e = !1, f = a.type;
                if (d && f === I.MEDIA_RULE) {
                    var k = a.selector.match(Sd);
                    k && (window.matchMedia(k[1]).matches || (e = !0))
                }
                f === I.STYLE_RULE ? b(a) : c && f === I.da ? c(a) : f === I.na && (e = !0);
                if ((a = a.rules) && !e) {
                    e = 0;
                    f = a.length;
            ...
            for (var b = 0; b < a.length; b++) {
                ...
                if (c.target !== document.documentElement && c.target !== document.head) for (var d = 0; d < c.addedNodes.length; d++) {
                    ...
                    if (e.nodeType === Node.ELEMENT_NODE) {
                        ...
                        k = h;
                        h = k.indexOf(p.a);
                        if ((k = -1 < h ? k[h + 1] : "") && f === e.ownerDocument) p.b(e,
                            k, !0); else if (f.nodeType === Node.DOCUMENT_FRAGMENT_NODE && (f = f.host)) if (f = R(f).is, k === f) for (e = window.ShadyDOM.nativeMethods.querySelectorAll.call(e, ":not(." + p.a + ")"), f = 0; f < e.length; f++) p.h(e[f], k); else k && p.b(e, k, !0), p.b(e, f)
                    }
                }
            }
        }
        ...
        function ub(a) {
            requestAnimationFrame(function () {
                Lc ? Lc(a) : (fb || (fb = new Promise(function (a) {
                    gb = a
                }), "complete" === document.readyState ? gb() : document.addEventListener("readystatechange", function () {
        ...
        (function (a) {
            ...
            var q = /(url\()([^)]*)(\))/g, t = /(@import[\s]+(?!url\())([^;]*)(;)/g,
                u = /(<link[^>]*)(rel=['|"]?stylesheet['|"]?[^>]*>)/g, p = {
                    $a: function (a, b) {
                        ...
                        c = p.Pa;
                        c || (c = document.implementation.createHTMLDocument("temp"), p.Pa = c, c.pa = c.createElement("base"), c.head.appendChild(c.pa), c.oa = c.createElement("a"));
                        c.pa.href = b;
                        c.oa.href = a;
                        return c.oa.href || a
                    }
            ...
            g.prototype.m = function (a, b) {
                ...
                if (c = a.querySelector("base")) b = p.$(c.getAttribute("href"), b), c.removeAttribute("href");
        ...
        E.ab = !(!Element.prototype.attachShadow || !Node.prototype.getRootNode);
        var hb = Object.getOwnPropertyDescriptor(Node.prototype, "firstChild");
        E.R = !!(hb && hb.configurable && hb.get);
        E.za = E.force || !E.ab;
        var X = Element.prototype,
            Mc = X.matches || X.matchesSelector || X.mozMatchesSelector || X.msMatchesSelector || X.oMatchesSelector || X.webkitMatchesSelector,
            Pa = document.createTextNode(""), Lb = 0, Oa = [];
        (new MutationObserver(function () {
            for (; Oa.length;) try {
                Oa.shift()()
            } catch (a) {
                throw Pa.textContent =
                    Lb++, a;
            }
        })).observe(Pa, {characterData: !0});
        var Wd = !!document.contains, aa = [], Qa;
        ma.list = aa;
        la.prototype.ib = function () {
            var a = this;
            this.a || (this.a = !0, Kb(function () {
                a.b()
            }))
        };
        ...
        var cc = Element.prototype.appendChild, Xa = Element.prototype.insertBefore, ba = Element.prototype.removeChild,
            kc = Element.prototype.setAttribute, Nc = Element.prototype.removeAttribute,
            ib = Element.prototype.cloneNode, Ya = Document.prototype.importNode,
            sc = Element.prototype.addEventListener, vc = Element.prototype.removeEventListener,
            rc = Window.prototype.addEventListener, uc = Window.prototype.removeEventListener,
            jb = Element.prototype.dispatchEvent, ca = Node.prototype.contains || HTMLElement.prototype.contains,
            Xd = Object.freeze({
                appendChild: cc,
                insertBefore: Xa,
                removeChild: ba,
            ...
            Ed = Pb("area base br col command embed hr img input keygen link meta param source track wbr".split(" ")),
            Fd = Pb("style script xmp iframe noembed noframes plaintext noscript".split(" ")),
            C = document.createTreeWalker(document,
                NodeFilter.SHOW_ALL, null, !1),
            D = document.createTreeWalker(document, NodeFilter.SHOW_ELEMENT, null, !1), Yd = Object.freeze({
                parentNode: U,
                firstChild: Ka,
                lastChild: La,
                previousSibling: Qb,
            ...
            kb = Object.getOwnPropertyDescriptor(Element.prototype, "innerHTML") || Object.getOwnPropertyDescriptor(HTMLElement.prototype, "innerHTML"),
            sa = document.implementation.createHTMLDocument("inert").createElement("div"),
            lb = Object.getOwnPropertyDescriptor(Document.prototype, "activeElement"), $b = {
                parentElement: {
                    get: function () {
                ...
                childNodes: {
                    ...
                    get: function () {
                        var a =
                            this.__shady && this.__shady.firstChild;
                    ...
                    get: function () {
                        ...
                        for (kb && kb.set ? kb.set.call(sa, a) :
                                 sa.innerHTML = a; sa.firstChild;) b.appendChild(sa.firstChild)
                    }, configurable: !0
                }
            }, Oc = {
                shadowRoot: {
                    get: function () {
                        return this.__shady && this.__shady.gb || null
                    }, configurable: !0
                }
            }, Ta = {
                activeElement: {
                    get: function () {
                        var a = lb && lb.get ? lb.get.call(document) : E.R ? void 0 : document.activeElement;
                        if (a && a.nodeType) {
                            var b = !!G(this);
                            if (this === document || b && this.host !== a && ca.call(this.host, a)) {
                ...
                a.__shady && a.__shady.Na || (a.__shady = a.__shady || {}, a.__shady.Na = !0, K(a, $b, !0))
            }, Ib = E.R ? function () {
            } : function (a) {
                a.__shady && a.__shady.La || (a.__shady = a.__shady || {}, a.__shady.La = !0, K(a, Sa, !0), K(a, Oc, !0))
            }, oa = null, da = "__eventWrappers" + Date.now(), Zd = {
                blur: !0,
                focus: !0,
                focusin: !0,
                focusout: !0,
                ...
                get composed() {
                    !1 !== this.isTrusted && void 0 === this.ea && (this.ea = Zd[this.type]);
                    return this.ea || !1
                }, composedPath: function () {
                    this.qa ||
                    (this.qa = Za(this.__target, this.composed));
                    return this.qa
                }, get target() {
            ...
            }, ab = {focus: !0, blur: !0}, $d = $a(window.Event), ae = $a(window.CustomEvent), be =
                $a(window.MouseEvent), Hb = {};
        ...
        l.prototype.F = function (a, b) {
            ...
            a.__shady = a.__shady || {};
            a.__shady.root = this;
            a.__shady.gb = "closed" !== this.H ? this : null;
            this.V = !1;
            this.b = [];
            this.a = {};
            this.c = [];
        ...
        l.prototype.L = function () {
            var a = this;
            this.V || (this.V = !0, Nb(function () {
                return a.va()
            }))
        };
        l.prototype.K = function () {
            for (var a, b = this; b;) b.V && (a = b), b = b.Ua();
            return a
        };
        l.prototype.Ua = function () {
            var a = this.host.getRootNode();
            if (G(a)) for (var b = this.host.childNodes, c = 0, d; c < b.length; c++) if (d = b[c], this.j(d)) return a
        };
        ...
        l.prototype.B = function () {
            ...
            for (a = 0; a < this.b.length; a++) {
                b = this.b[a];
                if (!b.__shady.assignedNodes.length) for (var c =
                    b.firstChild; c; c = c.nextSibling) this.h(c, b);
                c = b.parentNode;
        ...
        l.prototype.h = function (a, b) {
            ...
            b ? (b.__shady.assignedNodes.push(a),
                a.__shady.assignedSlot = b) : a.__shady.assignedSlot = void 0;
            c !== a.__shady.assignedSlot && a.__shady.assignedSlot && (a.__shady.assignedSlot.__shady.ka = !0)
        };
        l.prototype.o = function (a) {
            var b = a.__shady.assignedNodes;
            a.__shady.assignedNodes = [];
            a.__shady.P = [];
            if (a.__shady.ua = b) for (var c = 0; c < b.length; c++) {
                var d = b[c];
        ...
        l.prototype.O = function (a, b) {
            for (var c = S(a), d = Jd(b, b.length, c, c.length), e = 0, f = 0, k; e < d.length && (k = d[e]); e++) {
                for (var g = 0, l; g < k.T.length && (l = k.T[g]); g++) U(l) === a && ba.call(a, l), c.splice(k.index + f, 1);
                f -= k.W
            }
            for (e = 0; e < d.length && (k = d[e]); e++) for (f = c[k.index], g = k.index; g < k.index + k.W; g++) l = b[g], Xa.call(a, l, f), c.splice(g, 0, l)
        };
        l.prototype.Qa = function (a) {
            this.c.push.apply(this.c, [].concat(a instanceof
            Array ? a : id(hd(a))))
        };
        ...
        var Nd = {addEventListener: pc.bind(window), removeEventListener: tc.bind(window)}, Md = {
            addEventListener: pc, removeEventListener: tc, appendChild: function (a) {
                return Ua(this, a)
                ...
                if ("template" == this.localName) var b = ib.call(this,
                    a); else if (b = ib.call(this, !1), a) {
                    a = this.childNodes;
                ...
                if (Wd && ca.call(a, this) || a.documentElement && ca.call(a.documentElement, this)) return !0;
            ...
            assignedNodes: function (a) {
                if ("slot" === this.localName) return ic(this), this.__shady ? (a && a.flatten ? this.__shady.P : this.__shady.assignedNodes) || [] : []
            }
        }, zc = Na({
        ...
        var ce = HTMLElement.prototype.blur, Pd = Na({
            blur: function () {
                var a = this.__shady &&
                    this.__shady.root;
                (a = a && a.activeElement) ? a.blur() : ce.call(this)
            }
        });
        E.za && (window.ShadyDOM = {
            inUse: E.za,
            patch: function (a) {
                return a
            },
            ...
            filterMutations: Cd,
            observeChildren: Ad,
            unobserveChildren: zd,
            nativeMethods: Xd,
            nativeTree: Yd
        }, window.Event = $d, window.CustomEvent = ae, window.MouseEvent = be, Id(), Ld(), window.ShadowRoot = l);
        var Qd = new Set("annotation-xml color-profile font-face font-face-src font-face-uri font-face-format font-face-name missing-glyph".split(" "));
        B.prototype.B =
            function (a, b) {
                this.o.set(a, b);
        ...
        B.prototype.f = function (a, b) {
            var c = this;
            b = b ? b : {};
            var d = b.lb || new Set, e = b.Da || function (a) {
                return c.i(a)
            }, f = [];
            O(a, function (a) {
                if ("link" === a.localName && "import" === a.getAttribute("rel")) {
                    var b = a.import;
                    b instanceof Node && "complete" === b.readyState ? (b.__CE_isImportDocument = !0, b.__CE_hasRegistry =
        ...
        y.prototype.define = function (a, b) {
            ...
            if (!Cc(a)) throw new SyntaxError("The element name '" + a + "' is not valid.");
            ...
            try {
                var d = function (a) {
                    var b = e[a];
                    if (void 0 !== b && !(b instanceof Function)) throw Error("The '" +
                        a + "' callback must be a function.");
                    return b
                }, e = b.prototype;
        ...
        y.prototype.whenDefined = function (a) {
            if (!Cc(a)) return Promise.reject(new SyntaxError("'" + a + "' is not a valid custom element name."));
            var b = this.h.get(a);
            if (b) return b.f;
            b = new Gb;
            this.h.set(a, b);
        ...
        var Ea = window.Document.prototype.createElement, ud = window.Document.prototype.createElementNS,
            td = window.Document.prototype.importNode, vd = window.Document.prototype.prepend,
            wd = window.Document.prototype.append, de = window.DocumentFragment.prototype.prepend,
            ee = window.DocumentFragment.prototype.append, wb = window.Node.prototype.cloneNode,
            ia = window.Node.prototype.appendChild,
            Db = window.Node.prototype.insertBefore, Fa = window.Node.prototype.removeChild,
            Eb = window.Node.prototype.replaceChild,
            Ia = Object.getOwnPropertyDescriptor(window.Node.prototype, "textContent"),
            vb = window.Element.prototype.attachShadow,
            Ca = Object.getOwnPropertyDescriptor(window.Element.prototype, "innerHTML"),
            Ga = window.Element.prototype.getAttribute, xb = window.Element.prototype.setAttribute,
            zb = window.Element.prototype.removeAttribute, ja = window.Element.prototype.getAttributeNS,
            yb = window.Element.prototype.setAttributeNS,
            Ab = window.Element.prototype.removeAttributeNS, Cb = window.Element.prototype.insertAdjacentElement,
            kd = window.Element.prototype.prepend, ld = window.Element.prototype.append,
            nd = window.Element.prototype.before, od = window.Element.prototype.after,
            pd = window.Element.prototype.replaceWith, qd = window.Element.prototype.remove, yd = window.HTMLElement,
            Da = Object.getOwnPropertyDescriptor(window.HTMLElement.prototype, "innerHTML"),
            Bb = window.HTMLElement.prototype.insertAdjacentElement, Fb = new function () {
            }, ta = window.customElements;
        if (!ta || ta.forcePolyfill || "function" != typeof ta.define || "function" != typeof ta.get) {
            var Y = new B;
            xd(Y);
            sd(Y);
            Ha(Y, DocumentFragment.prototype, {Z: de, append: ee});
            rd(Y);
            jd(Y);
            document.__CE_hasRegistry = !0;
            var fe = new y(Y);
            Object.defineProperty(window, "customElements", {configurable: !0, enumerable: !0, value: fe})
        }
        var I = {STYLE_RULE: 1, da: 7, MEDIA_RULE: 4, na: 1E3}, F = {
            Za: /\/\*[^*]*\*+([^/*][^*]*\*+)*\//gim,
            port: /@import[^;]*;/gim,
            wa: /(?:^[^;\-\s}]+)?--[^;{}]*?:[^{};]*?(?:[;\n]|$)/gim,
            Aa: /(?:^[^;\-\s}]+)?--[^;{}]*?:[^{};]*?{[^}]*?}(?:[;\n]|$)?/gim,
        ...
        if (window.ShadyCSS && void 0 !== window.ShadyCSS.nativeCss) var A = window.ShadyCSS.nativeCss; else window.ShadyCSS ? (Fc(window.ShadyCSS), window.ShadyCSS = void 0) : Fc(window.WebComponents && window.WebComponents.flags);
        var ua = /(?:^|[;\s{]\s*)(--[\w-]*?)\s*:\s*(?:((?:'(?:\\'|.)*?'|"(?:\\"|.)*?"|\([^)]*?\)|[^};{])+)|\{([^}]*)\}(?:(?=[;\s}])|$))/gi,
            va = /(?:^|\W+)@apply\s*\(?([^);\n]*)\)?/gi, ge = /(--[\w-]+)\s*([:,;)]|$)/gi,
            he = /(animation\s*:)|(animation-name\s*:)/, Sd = /@media\s(.*)/, ie = /\{[^}]*\}/g, Q = null;
        ...
        u.prototype.j = function (a, b, c) {
            ...
            if (a = "template" === a.localName ? (a.content || a.pb).childNodes : a.children || a.childNodes) for (var d = 0; d < a.length; d++) this.j(a[d], b, c)
        };
        ...
        u.prototype.g = function (a, b, c) {
            ...
            a = a.trim();
            var f = mb.test(a);
            f && (a = a.replace(mb, function (a, b, c) {
                return ":" + b + "(" + c.replace(/\s/g, "") + ")"
            }), a = this.s(a));
            a = a.replace(le, nb + " $1");
            a = a.replace(me, function (a, f, g) {
                e || (a = d.B(g, f, b, c), e = e || a.stop, f = a.Ya, g = a.value);
                return f + g
            });
            f && (a = this.s(a));
            return a
        ...
        u.prototype.B = function (a, b, c, d) {
            var e = a.indexOf(ob);
            0 <= a.indexOf(nb) ? a = this.F(a, d) : 0 !== e && (a = c ? this.o(a, c) : a);
            c = !1;
            0 <= e && (b = "", c = !0);
            if (c) {
                var f = !0;
                c && (a = a.replace(ne, function (a, b) {
                    return " > " +
                        b
                }))
            }
            a = a.replace(oe, function (a, b, c) {
        ...
        u.prototype.F = function (a, b) {
            var c = a.match(Rc);
            return (c = c && c[2].trim() || "") ? c[0].match(Sc) ? a.replace(Rc, function (a, c, f) {
                return b + f
            }) : c.split(Sc)[0] === b ? c : pe : a.replace(nb, b)
        };
        ...
        var mb = /:(nth[-\w]+)\(([^)]+)\)/, Tc = ":not(.style-scope)", Pc = ",",
            me = /(^|[\s>+~]+)((?:\[.+?\]|[^\s>+~=[])+)/g, Sc = /[[.:#*]/, nb = ":host", qe = ":root", ob = "::slotted",
            le = new RegExp("^(" + ob + ")"), Rc = /(:host)(?:\(((?:\([^)(]*\)|[^)(]*)+?)\))/,
            ne = /(?:::slotted)(?:\(((?:\([^)(]*\)|[^)(]*)+?)\))/, oe = /(.*):dir\((?:(ltr|rtl))\)/,
            ke = ".", Qc = ":", je = "class", pe = "should_not_match", p = new u;
        v.get = function (a) {
        ...
        }(window.Element.prototype), re = navigator.userAgent.match("Trident");
        ...
        n.prototype.f = function (a,
            ...
            for (var c = 0, d, e; c < a.length; c++) if (d = a[c]) {
                va.lastIndex = 0;
                if (e = va.exec(d)) d = this.a(b[e[1]], b); else if (e = d.indexOf(":"), -1 !== e) {
                    var f = d.substring(e);
                    f = f.trim();
                    f = this.a(f, b) || f;
                    d = d.substring(0, e) + f
        ...
        n.prototype.O = function (a, b) {
            ...
            W(a, function (a) {
                ...
                b && a.u.C && f && Uc.call(b, f) && (d.b(a, c), a = a.index, f = parseInt(a / 32, 10), e[f] = (e[f] || 0) | 1 << a % 32)
            }, null, !0);
            return {C: c, key: e}
        };
        n.prototype.ca = function (a, b, c, d) {
            ...
            if (b.u.C) {
                ...
                e = e.U;
                e = a ? p.f(a, e) : "html";
                var f = b.parsedSelector, g = ":host > *" === f ||
                    "html" === f, h = 0 === f.indexOf(":host") && !g;
                "shady" === c && (g = f === e + " > *." + e || -1 !== f.indexOf("html"), h = !g && 0 === f.indexOf(e));
                "shadow" === c && (g = ":host > *" === f || "html" === f, h = h && !g);
                if (g || h) c = e, h && (z && !b.v && (b.v = p.m(b, p.g, p.i(a), e)), c = b.v || e), d({
                    jb: c,
                    cb: h,
                    rb: g
                })
        ...
        n.prototype.I = function (a, b) {
            ...
            W(b, function (b) {
                e.ca(a, b, f, function (f) {
                    Uc.call(a.qb || a, f.jb) && (f.cb ? e.b(b, c) : e.b(b, d))
                })
            }, null, !0);
            return {hb: d, bb: c}
        };
        n.prototype.ba = function (a, b, c) {
            var d = this, e = R(a), f = p.f(e.is,
                e.U),
        ...
        n.prototype.l = function (a, b, c, d) {
            a.v = a.v || a.selector;
            d = "." + d;
            for (var e = a.v.split(","), f = 0, g = e.length, h; f < g && (h = e[f]); f++) e[f] = h.match(b) ? h.replace(c, d) : d + " " + h;
            a.selector = e.join(",")
        };
        ...
        n.prototype.s = function (a, b, c, d) {
            ...
            z ? e.a ? (e.a.textContent = b, d = e.a) : b && (d = eb(b, c, a.shadowRoot, e.b)) : d ? d.parentNode || (re && -1 < b.indexOf("@media") && (d.textContent = b), Hc(d, null, e.b)) : b && (d = eb(b, c, null, e.b));
        ...
        n.prototype.m = function (a, b) {
            ...
            a.textContent = V(c, function (a) {
                ...
                a.u && a.u.cssText && (c = c.replace(F.wa, "").replace(F.Aa,
                    ""), a.cssText = d.f(c, b))
            })
        };
        ...
        var M = new n, pb = {}, wa = window.customElements;
        if (wa && !z) {
            var se = wa.define;
        ...
        if (!z) {
            var Vc = new MutationObserver(Jc), Wc = function (a) {
            ...
            if (window.customElements && !window.customElements.polyfillWrapFlushCallback) Wc(document); else {
                ...
                window.HTMLImports ?
                    window.HTMLImports.whenReady(qb) : requestAnimationFrame(function () {
        ...
        var ra = {}, Vd = Promise.resolve(), fb = null, Lc = window.HTMLImports && window.HTMLImports.whenReady || null,
            gb, xa = null, fa = null;
        ...
        q.prototype.c = function () {
            for (var a = this.customStyles, b = 0; b < a.length; b++) {
                ...
                if (!c.__shadyCSSCachedStyle) {
                    var d = this.a(c);
                    d && (d = d.__appliedElement || d, xa && xa(d), c.__shadyCSSCachedStyle = d)
                }
            }
            return a
        };
        ...
        g.prototype.prepareTemplate = function (a, b, c) {
            if (!a.f) {
                ...
                a.extends = c;
                ra[b] = a;
                var d = this.aa(a), e = this.H(a);
                c = {is: b, extends: c, nb: d};
                z || p.b(a.content, b);
                this.c();
                ...
                d = [];
                A || (d = M.H(a._styleAst));
                if (!d.length || A) b = this.O(c, a._styleAst, z ? a.content : null, pb[b]), a.a = b;
                a.c = d
            }
        };
        ...
        g.prototype.F = function () {
            !this.a && window.ShadyCSS && window.ShadyCSS.ApplyShim && (this.a = window.ShadyCSS.ApplyShim, this.a.invalidCallback = Td)
        };
        g.prototype.G = function () {
            var a = this;
            !this.b && window.ShadyCSS && window.ShadyCSS.CustomStyleInterface &&
            (this.b = window.ShadyCSS.CustomStyleInterface, this.b.transformCallback = function (b) {
                a.s(b)
        ...
        g.prototype.f = function () {
            ...
            if (this.b) {
                ...
                this.b.enqueued && (A ? this.Fa(a) : (this.o(this.g, this.h), this.B(a)), this.b.enqueued = !1, this.i && !A && this.styleDocument())
            }
        };
        g.prototype.styleElement = function (a, b) {
            var c = R(a).is, d = v.get(a);
            d || (d = this.ca(a));
            this.j(a) || (this.i = !0);
            ...
            if (A) {
                ...
                if (((e = ra[c]) || this.j(a)) && e && e.a && !Kc(e)) {
                    if (Kc(e) || e._applyShimValidatingVersion !== e._applyShimNextVersion) this.c(), this.a && this.a.transformRules(e._styleAst, c), e.a.textContent = p.c(a, d.D), Ud(e);
                    z && (c = a.shadowRoot) && (c.querySelector("style").textContent = p.c(a, d.D));
                    d.D = e._styleAst
                }
        ...
        g.prototype.K = function (a, b) {
            var c = R(a).is, d = Xc.fetch(c, b.J, b.la), e = d ? d.styleElement : null, f = b.A;
            b.A = d && d.A || this.I(c);
            e = M.s(a, b.J, b.A, e);
            z || M.o(a, b.A, f);
            d || Xc.b(c, b.J, e, b.A)
        ...
        g.prototype.Ia = function (a, b) {
            ...
            if (!c) {
                ...
                if (d) {
                    d = d.split(/\s/);
                    for (var e = 0; e < d.length; e++) if (d[e] === p.a) {
                        c = d[e + 1];
                        break
                    }
                }
        ...
        window.ShadyCSS = {
            ScopingShim: H, prepareTemplate: function (a, b, c) {
                H.f();
        ...
        Zc && (window.ShadyCSS.CustomStyleInterface =
            Zc);
        var rb = window.customElements, ya = window.HTMLImports, $c = window.HTMLTemplateElement;
        window.WebComponents = window.WebComponents || {};
        if (rb && rb.polyfillWrapFlushCallback) {
            var za, ad = function () {
                if (za) {
                    $c.Xa && $c.Xa(window.document);
                    var a = za;
                    za = null;
                    a();
                    return !0
        ...
        var cd = document.createElement("style");
        cd.textContent = "body {transition: opacity ease-in 0.2s; } \nbody[unresolved] {opacity: 0; display: block; overflow: hidden; position: relative; } \n";
        var dd = document.querySelector("head");
        dd.insertBefore(cd, dd.firstChild)
    })();
}).call(this);
