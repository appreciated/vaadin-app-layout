...
*/
    ...
    (function () {
        ...
        var f = Node.prototype.cloneNode, h = Document.prototype.createElement, g = Document.prototype.importNode,
            ...
            t = Document.prototype.querySelectorAll, C = DocumentFragment.prototype.querySelectorAll, eb = function () {
                if (!c) {
        ...
        if (c) {
            var J = document.implementation.createHTMLDocument("template"), Ca = !0,
                Da = document.createElement("style");
            Da.textContent = "template{display:none;}";
            var Ea = document.head;
            Ea.insertBefore(Da, Ea.firstElementChild);
            a.prototype = Object.create(HTMLElement.prototype);
            var x = !document.createElement("div").hasOwnProperty("innerHTML");
            a.D = function (b) {
                if (!b.content) {
                    b.content = J.createDocumentFragment();
            ...
            var na = function (b) {
                Object.defineProperty(b, "innerHTML", {
                    get: function () {
                        for (var a =
                            "", b = this.content.firstChild; b; b = b.nextSibling) a += b.outerHTML || b.data.replace(oa, U);
                        return a
                    }, set: function (b) {
                        J.body.innerHTML = b;
                        for (a.J(J); this.content.firstChild;) k.call(this.content, this.content.firstChild);
                        for (; J.body.firstChild;) l.call(this.content, J.body.firstChild)
                    }, configurable: !0
                })
            }, aa = function (a) {
                Object.defineProperty(a, "outerHTML", {
                    get: function () {
                        ...
                        if (this.parentNode) {
                            J.body.innerHTML = a;
                            for (a = this.ownerDocument.createDocumentFragment(); J.body.firstChild;) l.call(a,
                                J.body.firstChild);
        ...
        if (c || eb) {
            a.ca = function (a, b) {
                var c = f.call(a, !1);
                this.D && this.D(c);
                b && (l.call(c.content, f.call(a.content, !0)), fb(c.content, a.content));
                return c
            };
            var fb = function (c, d) {
                if (d.querySelectorAll && (d = b(d, "template"), 0 !== d.length)) {
                    c = b(c, "template");
                    for (var e = 0, f = c.length, h, g; e < f; e++) g = d[e], h = c[e], a && a.D && a.D(g), m.call(h.parentNode, pa.call(g, !0), h)
                }
            }, pa = Node.prototype.cloneNode = function (b) {
                if (!e &&
                    d && this instanceof DocumentFragment) if (b) var c = qa.call(this.ownerDocument, this, !0); else return this.ownerDocument.createDocumentFragment(); else c = this.nodeType === Node.ELEMENT_NODE && "template" === this.localName ? a.ca(this, b) : f.call(this, b);
                b && fb(c, this);
                return c
            }, qa = Document.prototype.importNode = function (c, d) {
                d = d || !1;
                if ("template" === c.localName) return a.ca(c, d);
                ...
                if (d) {
                    ...
                    for (var f,
                        ...
                        for (var l = f.attributes, qa = 0, pa; qa < l.length; qa++) pa = l[qa], d.setAttribute(pa.name, pa.value);
    ...
    var la = 0, ma, ra = "undefined" !== typeof window ? window : void 0, sa = ra || {},
    ...
    function ya() {
        var a = 0, b = new ta(wa), c = document.createTextNode("");
    ...
    function wa() {
        for (var a = 0; a < la; a += 2) (0, Aa[a])(Aa[a + 1]), Aa[a] = void 0, Aa[a + 1] = void 0;
        la = 0
    }
    ...
    function La(a, b) {
        var c = this, d = new this.constructor(Ma);
        void 0 === d[Na] && Oa(d);
        var e = c.g;
        if (e) {
            var f = arguments[e - 1];
    ...
    function Ra(a) {
        ...
        Sa(b, a);
        return b
    };var Na = Math.random().toString(36).substring(16);
    ...
    function Sa(a, b) {
        if (a === b) u(a, new TypeError("You cannot resolve a promise with itself")); else {
            var c = typeof b;
            null === b || "object" !== c && "function" !== c ? r(a, b) : Za(a, b, Va(b))
        }
    }
    ...
    function ab(a) {
        var b = a.I, c = a.g;
        if (0 !== b.length) {
            for (var d, e, f = a.f, h = 0; h < b.length; h += 3) d = b[h], e = b[h + c], d ? Pa(c, d, e, f) : e(f);
            a.I.length = 0
        }
    }
    ...
    function Pa(a, b, c, d) {
        ...
        void 0 === b.g && (e && k ? Sa(b, f) : h ? u(b, g) : 1 === a ? r(b, f) : 2 === a && u(b, f))
    }
    ...
    function gb(a, b) {
        ...
        this.A = new a(Ma);
        this.A[Na] || Oa(this.A);
        if (ka(b)) if (this.S = this.length = b.length, this.f = Array(this.length), 0 === this.length) r(this.A, this.f); else {
            this.length = this.length || 0;
            for (a = 0; void 0 === this.g && a < b.length; a++) hb(this, b[a], a);
            0 === this.S && r(this.A, this.f)
        } else u(this.A, Error("Array Methods must be provided an Array"))
    }

    function hb(a, b, c) {
        var d = a.Ea, e = d.resolve;
        e === Ra ? (e = Va(b), e === La && void 0 !== b.g ? ib(a, b.g, c, b.f) : "function" !== typeof e ? (a.S--, a.f[c] = b) : d === v ? (d = new d(Ma), Za(d, b, e), jb(a, d, c)) : jb(a, new d(function (a) {
            return a(b)
        }), c)) : jb(a, e(b), c)
    }
    ...
    function v(a) {
        ...
        if (Ma !== a) {
            ...
            if (this instanceof v) cb(this, a); else throw new TypeError("Failed to construct 'Promise': Please use the 'new' operator, this object constructor cannot be called as a function.");
        }
    }

    v.prototype = {
        constructor: v, then: La, a: function (a) {
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
    window.Promise || (window.Promise = v, v.prototype["catch"] = v.prototype.a, v.prototype.then = v.prototype.then, v.all = kb, v.race = lb, v.resolve = Ra, v.reject = mb);
    (function (a) {
        function b(a, b) {
        ...
        var t = document.createElement("link"), C = "import" in t, eb = t.querySelectorAll("*"), J = null;
        ...
        var Ca = /(url\()([^)]*)(\))/g, Da = /(@import[\s]+(?!url\())([^;]*)(;)/g,
            Ea = /(<link[^>]*)(rel=['|"]?stylesheet['|"]?[^>]*>)/g, x = {
                La: function (a, b) {
                    a.href && a.setAttribute("href", x.Y(a.getAttribute("href"), b));
                    a.src && a.setAttribute("src", x.Y(a.getAttribute("src"), b));
                    if ("style" === a.localName) {
                        var c = x.ta(a.textContent, b, Ca);
                        a.textContent = x.ta(c, b, Da)
                    }
                }, ta: function (a, b, c) {
                    return a.replace(c,
                        function (a, c, d, e) {
                    ...
                    if (void 0 === x.ba) {
                        ...
                        try {
                            ...
                            c.pathname = "c%20d";
                            x.ba = "http://a/c%20d" === c.href
                        } catch (Lg) {
                        }
                    }
                    if (x.ba) return (new URL(a, b)).href;
                    c = x.Ba;
                    c || (c = document.implementation.createHTMLDocument("temp"), x.Ba = c, c.ma = c.createElement("base"), c.head.appendChild(c.ma), c.la = c.createElement("a"));
                    c.ma.href = b;
                    c.la.href = a;
                    return c.la.href || a
                }
        ...
        k.prototype.s = function (a) {
            ...
            if (void 0 !== this.a[c]) {
                var d = this.a[c];
                d && d.__loaded && (a.__import = d, this.h(a))
        ...
        k.prototype.Sa = function (a, b) {
            ...
            aa && (a = a.replace(Ea, function (a, b, c) {
                return -1 ===
            ...
            if (c = a.querySelector("base")) b = x.Y(c.getAttribute("href"), b), c.removeAttribute("href");
...
*/
    ...
    var nb = document.querySelector('script[src*="webcomponents-lite.js"]'), ob = /wc-(.+)/, w = {};
    if (!w.noOpts) {
        location.search.slice(1).split("&").forEach(function (a) {
            a = a.split("=");
            var b;
            a[0] && (b = a[0].match(ob)) && (w[b[1]] = a[1] || !0)
        });
        if (nb) for (var pb = 0, qb; qb = nb.attributes[pb]; pb++) "src" !== qb.name && (w[qb.name] = qb.value || !0);
    ...
    var sb = w.shadydom;
    sb && (window.ShadyDOM = window.ShadyDOM || {}, window.ShadyDOM.force = sb);
    var tb = w.register || w.ce;
    tb && window.customElements && (window.customElements.forcePolyfill = tb);
    /*
...
*/
    ...
    y.Na = !(!Element.prototype.attachShadow || !Node.prototype.getRootNode);
    var ub = Object.getOwnPropertyDescriptor(Node.prototype, "firstChild");
    y.M = !!(ub && ub.configurable && ub.get);
    y.sa = y.force || !y.Na;
    ...
    var Cb = document.createTextNode(""), Db = 0, Eb = [];
    ...
    function Pb(a, b) {
        a.__shady = a.__shady || {};
        a.__shady.N || (a.__shady.N = new Mb);
        a.__shady.N.V.add(b);
        var c = a.__shady.N;
        return {
            Ca: b, C: c, Ga: a, takeRecords: function () {
    ...
    function Qb(a) {
        var b = a && a.C;
        b && (b.V.delete(a.Ca), b.V.size || (a.Ga.__shady.N = null))
    }
    ...
    };var A = {}, Sb = Element.prototype.insertBefore, Tb = Element.prototype.removeChild,
        Ub = Element.prototype.setAttribute, Vb = Element.prototype.removeAttribute, Wb = Element.prototype.cloneNode,
        Xb = Document.prototype.importNode, Yb = Element.prototype.addEventListener,
        Zb = Element.prototype.removeEventListener, $b = Window.prototype.addEventListener,
        ac = Window.prototype.removeEventListener, bc = Element.prototype.dispatchEvent,
    ...
    A.removeChild = Tb;
    A.setAttribute = Ub;
    A.removeAttribute = Vb;
    A.cloneNode = Wb;
    A.importNode = Xb;
    A.addEventListener = Yb;
    A.removeEventListener = Zb;
    A.ab = $b;
    A.bb = ac;
    A.dispatchEvent = bc;
    A.querySelector = cc;
    A.querySelectorAll = dc;
    A.contains = ec;
    var fc = /[&\u00A0"]/g, gc = /[&\u00A0<>]/g;
    ...
    function lc(a, b) {
            ...
            a:{
                ...
                switch (g.nodeType) {
                    case Node.ELEMENT_NODE:
                        for (var m = g.localName, n = "<" + m, t = g.attributes, C = 0; k = t[C]; C++) n += " " + k.name + '="' + k.value.replace(fc, hc) + '"';
                        n += ">";
                        g = jc[m] ? n : n + lc(g, l) + "</" + m + ">";
                        break a;
                    case Node.TEXT_NODE:
                        g = g.data;
                        g = k && kc[k.localName] ? g : g.replace(gc, hc);
                        break a;
        ...
        return c
    };var B = {}, D = document.createTreeWalker(document, NodeFilter.SHOW_ALL, null, !1),
    ...
    var nc = Object.getOwnPropertyDescriptor(Element.prototype, "innerHTML") || Object.getOwnPropertyDescriptor(HTMLElement.prototype, "innerHTML"),
        ...
        pc = Object.getOwnPropertyDescriptor(Document.prototype, "activeElement"), qc = {
            parentElement: {
                get: function () {
            ...
            activeElement: {
                get: function () {
                    var a = pc && pc.get ? pc.get.call(document) : y.M ? void 0 : document.activeElement;
                    if (a && a.nodeType) {
                        var b = !!z(this);
                        if (this === document || b && this.host !== a && A.contains.call(this.host, a)) {
                            for (b = wb(a); b && b !== this;) a = b.host, b = wb(a);
    ...
    function xc(a) {
        if (!a.__shady || void 0 === a.__shady.firstChild) {
            ...
            vc(a);
            for (var b = a.__shady.childNodes = B.childNodes(a), c = 0, d; c < b.length && (d = b[c]); c++) d.__shady = d.__shady || {}, d.__shady.parentNode = a, d.__shady.nextSibling = b[c + 1] || null, d.__shady.previousSibling = b[c - 1] || null, uc(d)
        }
    };
    ...
    function yc(a, b, c) {
        ...
        if (c === b) return b;
        b.parentNode && zc(b.parentNode, b);
        d = wb(a);
        var e;
        if (e = d) a:{
        ...
        if (vb(a)) {
            ...
            if (b.nodeType === Node.DOCUMENT_FRAGMENT_NODE) {
                f = b.childNodes;
                for (e = 0; e < f.length; e++) wc(f[e], a, d);
                b.__shady = b.__shady || {};
        ...
        h || (h = z(a) ? a.host : a, c ? (c = Cc(c), A.insertBefore.call(h, b, c)) : A.appendChild.call(h, b));
        Dc(a, b);
        return b
    }
            ...
            for (var h in e) for (var g = e[h], k = 0; k < g.length; k++) {
                ...
                if (Hb(b, l)) {
                    ...
                    if (m = l.__shady.K) for (l = 0; l < m.length; l++) {
                        var n = m[l], t = B.parentNode(n);
                        t && A.removeChild.call(t, n)
                    }
                    m = !0
                }
            }
    ...
    function Ec(a) {
        if (a.__shady && void 0 !== a.__shady.ka) for (var b = a.childNodes, c = 0, d = b.length, e; c < d && (e = b[c]); c++) Ec(e);
        a.__shady && (a.__shady.ka = void 0)
    }

    function Cc(a) {
        var b = a;
        a && "slot" === a.localName && (b = (b = a.__shady && a.__shady.K) && b.length ? b[0] : Cc(a.nextSibling));
        return b
    }
    ...
    function Kc(a) {
        if (a && a.nodeType) {
            a.__shady = a.__shady || {};
            var b = a.__shady.ka;
            void 0 === b && (b = z(a) ? a : (b = a.parentNode) ? Kc(b) : a, A.contains.call(document.documentElement, a) && (a.__shady.ka = b));
            return b
        }
    }
    ...
    function Mc(a, b, c, d) {
        for (var e = 0, f = a.length, h; e < f && (h = a[e]); e++) {
            ...
            if (g = h.nodeType === Node.ELEMENT_NODE) {
                ...
                n && m.push(g);
                l && l(n) ? g = n : (Mc(g.childNodes, k, l, m), g = void 0)
            }
            if (g) break
        }
    }
    ...
    function Oc(a, b, c) {
        Nc || (Nc = window.ShadyCSS && window.ShadyCSS.ScopingShim);
        Nc && "class" === b ? Nc.setElementClass(a, c) : (A.setAttribute.call(a, b, c), Hc(a, b))
    }
    ...
    function Pc(a, b) {
        ...
        if (b) {
            a = a.childNodes;
            b = 0;
            for (var d; b < a.length; b++) d = Pc(a[b], !0), c.appendChild(d)
        }
        return c
    };var Qc = "__eventWrappers" + Date.now(), Rc = {
        blur: !0,
        focus: !0,
        focusin: !0,
        focusout: !0,
    ...
    var Uc = {
        get composed() {
            !1 !== this.isTrusted && void 0 === this.Z && (this.Z = Rc[this.type]);
            return this.Z || !1
        }, composedPath: function () {
            this.b || (this.b = Sc(this.__target, this.composed));
            return this.b
        }, get target() {
            return Tc(this.currentTarget, this.composedPath())
        }, get relatedTarget() {
            if (!this.$) return null;
            this.c || (this.c = Sc(this.$, !0));
            return Tc(this.currentTarget, this.c)
    ...
    function Zc(a) {
        ...
        for (c = 0; c < b.length; c++) {
            ...
            if (0 === c || f && f === e) if (Yc(a, d, "bubble"), d !== window && (e = d.getRootNode()), a.a) break
        }
    }
    ...
    function ad(a, b, c) {
        if (b) {
            ...
            if ("function" === d || "object" === d) if ("object" !== d || b.handleEvent && "function" === typeof b.handleEvent) {
                ...
                b[Qc].push({node: this, type: a, capture: e, once: f, passive: h, cb: k});
                Wc[a] ? (this.__handlers =
                    this.__handlers || {}, this.__handlers[a] = this.__handlers[a] || {
                    capture: [],
                    bubble: []
                }, this.__handlers[a][e ? "capture" : "bubble"].push(k)) : (this instanceof Window ? A.ab : A.addEventListener).call(this, a, k, c)
            }
        }
    }
    ...
    function cd(a, b, c) {
        if (b) {
            ...
            var h = c && c.aa || this, g = void 0;
            var k = null;
            try {
                k = b[Qc]
            } catch (l) {
            }
            k && (e = $c(k, h, a, d, e, f), -1 < e && (g = k.splice(e, 1)[0].cb, k.length || (b[Qc] = void 0)));
            (this instanceof Window ? A.bb : A.removeEventListener).call(this, a, g || b, c);
            g && Wc[a] && this.__handlers && this.__handlers[a] && (a = this.__handlers[a][d ? "capture" : "bubble"], g = a.indexOf(g), -1 < g && a.splice(g, 1))
        }
    }

    function dd() {
        for (var a in Wc) window.addEventListener(a, function (a) {
    ...
    var ed = Vc(window.Event), fd = Vc(window.CustomEvent), gd = Vc(window.MouseEvent);
    ...
    function H(a, b, c) {
        ...
        b.__shady = b.__shady || {};
        b.__shady.root = a;
        b.__shady.Va = "closed" !== a.Fa ? a : null;
        a.T = !1;
        a.o = [];
        a.l = {};
        a.H = [];
    ...
    H.prototype = Object.create(DocumentFragment.prototype);
    ...
    H.prototype._renderRoot = function () {
        this.T = !1;
        Fc(this);
        for (var a = 0, b; a < this.o.length; a++) {
            b = this.o[a];
            var c = b.__shady.assignedNodes;
            b.__shady.assignedNodes = [];
            b.__shady.K = [];
            if (b.__shady.oa = c) for (var d = 0; d < c.length; d++) {
                var e = c[d];
        ...
        for (a = 0; a < this.o.length; a++) {
            b = this.o[a];
            if (!b.__shady.assignedNodes.length) for (c = b.firstChild; c; c = c.nextSibling) md(this,
                c, b);
            c = b.parentNode;
            (c = c.__shady && c.__shady.root) && Gc(c) && c._renderRoot();
            nd(this, b.__shady.K, b.__shady.assignedNodes);
            if (c = b.__shady.oa) {
    ...
    function od(a, b) {
        ...
        b.__shady.assignedSlot && od(a, b.__shady.assignedSlot)
    }
    ...
    function Fc(a) {
        if (a.H.length) {
            ...
            if (c) for (var h in c) a.l[h] = Jc(a.l[h]);
            a.H = []
        }
    }
    ...
    function Jc(a) {
        return a.sort(function (a, c) {
            a = pd(a);
            for (var b = pd(c), e = 0; e < a.length; e++) {
                c = a[e];
                var f = b[e];
    ...
    var sd = {addEventListener: ad.bind(window), removeEventListener: cd.bind(window)}, td = {
        addEventListener: ad, removeEventListener: cd, appendChild: function (a) {
            ...
            if (Gb && A.contains.call(a, this) || a.documentElement && A.contains.call(a.documentElement, this)) return !0;
            for (a = this; a && !(a instanceof Document);) a = a.parentNode || (a instanceof H ? a.host : void 0);
    ...
    Object.defineProperties(yd, {_activeElement: tc.activeElement});
    var zd = HTMLElement.prototype.blur, Ad = Ab({
        blur: function () {
            var a = this.__shady && this.__shady.root;
            (a = a && a.activeElement) ? a.blur() : zd.call(this)
        }
    });
    ...
    if (y.sa) {
        ...
        dd();
        var Bd = window.customElements && window.customElements.nativeHTMLElement || HTMLElement;
        I(window.Node.prototype, td);
        I(window.Window.prototype, sd);
        I(window.Text.prototype, ud);
        I(window.DocumentFragment.prototype, vd);
        I(window.Element.prototype,
            xd);
        I(window.Document.prototype, yd);
        window.HTMLSlotElement && I(window.HTMLSlotElement.prototype, wd);
        I(Bd.prototype, Ad);
        y.M && (G(window.Node.prototype), G(window.Text.prototype), G(window.DocumentFragment.prototype), G(window.Element.prototype), G(Bd.prototype), G(window.Document.prototype), window.HTMLSlotElement && G(window.HTMLSlotElement.prototype));
        window.ShadowRoot = H
    }
    ;var Cd = new Set("annotation-xml color-profile font-face font-face-src font-face-uri font-face-format font-face-name missing-glyph".split(" "));
    ...
    function P(a, b, c) {
        c = void 0 === c ? {} : c;
        var d = c.$a || new Set, e = c.va || function (b) {
            return Jd(a, b)
        }, f = [];
        L(b, function (b) {
    ...
    Kd.prototype.b = function (a) {
        ...
        for (b = 0; b < a.length; b++) for (var c = a[b].addedNodes, d = 0; d < c.length; d++) P(this.j, c[d])
    };
    ...
    Q.prototype.define = function (a, b) {
        ...
        if (!Dd(a)) throw new SyntaxError("The element name '" + a + "' is not valid.");
    ...
    function Md(a) {
        if (!1 !== a.R) {
            ...
            for (e = 0; e < c.length; e++) Jd(a.j, c[e]);
            for (; 0 < b.length;) {
                var f = b.shift();
                e = f.localName;
                f = d.get(f.localName);
                for (var h = 0; h < f.length; h++) Jd(a.j, f[h]);
    ...
    Q.prototype.a = function (a) {
        if (!Dd(a)) return Promise.reject(new SyntaxError("'" + a + "' is not a valid custom element name."));
        var b = this.ha.get(a);
        if (b) return b.c;
        b = new Ld;
        this.ha.set(a, b);
    ...
    Q.prototype.whenDefined = Q.prototype.a;
    Q.prototype.polyfillWrapFlushCallback = Q.prototype.b;
    var Nd = window.Document.prototype.createElement, Od = window.Document.prototype.createElementNS,
        Pd = window.Document.prototype.importNode, Qd = window.Document.prototype.prepend,
        Rd = window.Document.prototype.append, Sd = window.DocumentFragment.prototype.prepend,
        Td = window.DocumentFragment.prototype.append, Ud = window.Node.prototype.cloneNode,
        Vd = window.Node.prototype.appendChild, Wd = window.Node.prototype.insertBefore,
        Xd = window.Node.prototype.removeChild, Yd = window.Node.prototype.replaceChild,
        Zd = Object.getOwnPropertyDescriptor(window.Node.prototype,
            "textContent"), $d = window.Element.prototype.attachShadow,
        ae = Object.getOwnPropertyDescriptor(window.Element.prototype, "innerHTML"),
        be = window.Element.prototype.getAttribute, ce = window.Element.prototype.setAttribute,
        de = window.Element.prototype.removeAttribute, ee = window.Element.prototype.getAttributeNS,
        fe = window.Element.prototype.setAttributeNS, ge = window.Element.prototype.removeAttributeNS,
        he = window.Element.prototype.insertAdjacentElement, ie = window.Element.prototype.prepend,
        je = window.Element.prototype.append,
        ke = window.Element.prototype.before, le = window.Element.prototype.after,
        me = window.Element.prototype.replaceWith, ne = window.Element.prototype.remove, oe = window.HTMLElement,
    ...
    function se() {
        ...
        window.HTMLElement = function () {
            function b() {
                ...
                if (0 === e.length) return e = Nd.call(document, d.localName), Object.setPrototypeOf(e, b.prototype), e.__CE_state = 1, e.__CE_definition = d, a.b(e), e;
                d = e.length - 1;
                var f = e[d];
                if (f === re) throw Error("The HTMLElement constructor was either called reentrantly for this constructor or called multiple times.");
                e[d] = re;
    ...
    function ve() {
        ...
        M(Document.prototype, "importNode", function (b, c) {
            b = Pd.call(this, b, c);
            this.__CE_hasRegistry ? P(a, b) : Id(a, b);
            return b
        });
    ...
    function we() {
            ...
            Object.defineProperty(b, "textContent", {
                ...
                set: function (b) {
                    if (this.nodeType === Node.TEXT_NODE) d.set.call(this, b); else {
                        ...
                        d.set.call(this, b);
                        if (c) for (b = 0; b < c.length; b++) O(a, c[b])
                    }
                }
            })
        }
        ...
        M(Node.prototype, "insertBefore", function (b, d) {
            if (b instanceof DocumentFragment) {
                ...
                b = Wd.call(this, b, d);
                if (K(this)) for (d = 0; d < c.length; d++) N(a, c[d]);
                return b
            }
            c = K(b);
            d = Wd.call(this, b, d);
        ...
        M(Node.prototype, "appendChild", function (b) {
            if (b instanceof DocumentFragment) {
                var c = Array.prototype.slice.apply(b.childNodes);
                b = Vd.call(this, b);
                if (K(this)) for (var e = 0; e < c.length; e++) N(a, c[e]);
                return b
            }
            c = K(b);
            e = Vd.call(this, b);
        ...
        M(Node.prototype, "cloneNode", function (b) {
            b = Ud.call(this, b);
            this.ownerDocument.__CE_hasRegistry ? P(a, b) :
                Id(a, b);
            return b
        });
        M(Node.prototype, "removeChild", function (b) {
            var c = K(b), e = Xd.call(this, b);
            c && O(a, b);
            return e
        });
        M(Node.prototype, "replaceChild", function (b, d) {
            if (b instanceof DocumentFragment) {
                var c = Array.prototype.slice.apply(b.childNodes);
                b = Yd.call(this, b, d);
                if (K(this)) for (O(a, d), d = 0; d < c.length; d++) N(a, c[d]);
                return b
            }
            c = K(b);
            var f = Yd.call(this, b, d), h = K(this);
            h && O(a, d);
            c && O(a, b);
            h && N(a, b);
            return f
        ...
        Zd && Zd.get ? b(Node.prototype, Zd) : Hd(a, function (a) {
            b(a, {
                enumerable: !0, configurable: !0, get: function () {
                    ...
                    for (; this.firstChild;) Xd.call(this, this.firstChild);
        ...
        function c(b) {
            return function (c) {
                ...
                for (var g = [], k = 0; k < d.length; k++) {
                    var l = d[k];
                    l instanceof Element && K(l) && g.push(l);
                    if (l instanceof DocumentFragment) for (l = l.firstChild; l; l = l.nextSibling) e.push(l); else e.push(l)
                }
                b.apply(this, d);
                for (d = 0; d < g.length; d++) O(a, g[d]);
                if (K(this)) for (d = 0; d < e.length; d++) g = e[d], g instanceof Element && N(a, g)
            }
        }

        void 0 !== ke && (b.before = c(ke));
        void 0 !== ke && (b.after = c(le));
        void 0 !==
        me && M(b, "replaceWith", function (b) {
            for (var c = [], d = 0; d < arguments.length; ++d) c[d - 0] = arguments[d];
            d = [];
            for (var h = [], g = 0; g < c.length; g++) {
                var k = c[g];
                k instanceof Element && K(k) && h.push(k);
                if (k instanceof DocumentFragment) for (k = k.firstChild; k; k = k.nextSibling) d.push(k); else d.push(k)
            }
            g = K(this);
            me.apply(this, c);
            for (c = 0; c < h.length; c++) O(a, h[c]);
            if (g) for (O(a, this), c = 0; c < d.length; c++) h = d[c], h instanceof Element && N(a, h)
        });
        ...
        function b(b, c) {
            Object.defineProperty(b, "innerHTML", {
                ...
                set: function (b) {
                    ...
                    this.ownerDocument.__CE_hasRegistry ? P(a, this) : Id(a, this);
                    return b
                }
            })
        }
            ...
            b(a, {
                enumerable: !0, configurable: !0, get: function () {
                    ...
                    var b = "template" === this.localName, c = b ? this.content : this,
                        d = Nd.call(document, this.localName);
                    for (d.innerHTML = a; 0 < c.childNodes.length;) Xd.call(c, c.childNodes[0]);
                    for (a = b ? d.content : d; 0 < a.childNodes.length;) Vd.call(c,
                        a.childNodes[0])
                }
            })
        });
        M(Element.prototype, "setAttribute", function (b, c) {
            if (1 !== this.__CE_state) return ce.call(this, b, c);
            var d = be.call(this, b);
            ce.call(this, b, c);
            c = be.call(this, b);
            a.attributeChangedCallback(this, b, d, c, null)
        });
        M(Element.prototype, "setAttributeNS", function (b, c, f) {
            if (1 !== this.__CE_state) return fe.call(this, b, c, f);
            var d = ee.call(this, b, c);
            fe.call(this, b, c, f);
            f = ee.call(this, b, c);
            a.attributeChangedCallback(this, c, d, f, b)
        });
        M(Element.prototype, "removeAttribute", function (b) {
            if (1 !== this.__CE_state) return de.call(this,
                b);
            var c = be.call(this, b);
            de.call(this, b);
            null !== c && a.attributeChangedCallback(this, b, c, null, null)
        });
        M(Element.prototype, "removeAttributeNS", function (b, c) {
            if (1 !== this.__CE_state) return ge.call(this, b, c);
            var d = ee.call(this, b, c);
            ge.call(this, b, c);
            var e = ee.call(this, b, c);
            d !== e && a.attributeChangedCallback(this, c, d, e, b)
        });
        qe ? c(HTMLElement.prototype, qe) : he ? c(Element.prototype, he) : console.warn("Custom Elements: `Element#insertAdjacentElement` was not patched.");
        ue(a, Element.prototype, {X: ie, append: je});
        xe(a)
    }
    ;var ze = window.customElements;
    if (!ze || ze.forcePolyfill || "function" != typeof ze.define || "function" != typeof ze.get) {
        var te = new Fd;
        se();
        ve();
        ue(te, DocumentFragment.prototype, {X: Sd, append: Td});
        we();
        ye();
        document.__CE_hasRegistry = !0;
        var customElements = new Q(te);
    ...
    function Be(a) {
        a = a.replace(Ce, "").replace(De, "");
        var b = Ee, c = a, d = new Ae;
        d.start = 0;
        d.end = c.length;
    ...
    function Ee(a, b) {
        ...
        a.parent && (c = b.substring(a.previous ? a.previous.end : a.parent.start, a.start - 1), c = Fe(c), c = c.replace(Ge, " "), c = c.substring(c.lastIndexOf(";") + 1), c = a.parsedSelector = a.selector = c.trim(), a.atRule = 0 === c.indexOf("@"), a.atRule ? 0 === c.indexOf("@media") ? a.type = He : c.match(Ie) && (a.type = Je, a.keyframesName = a.selector.split(Ge).pop()) : a.type = 0 === c.indexOf("--") ? Ke : Le);
        if (c = a.rules) for (var d = 0, e = c.length, f; d < e && (f = c[d]); d++) Ee(f,
            b);
        return a
    }
    ...
    function Me(a, b, c) {
        ...
        if (a.cssText || a.rules) {
            ...
            if (f) {
                f = 0;
                for (var h = e.length, g; f < h && (g = e[f]); f++) d = Me(g, b, d)
    ...
    var Le = 1, Je = 7, He = 4, Ke = 1E3, Ce = /\/\*[^*]*\*+([^/*][^*]*\*+)*\//gim, De = /@import[^;]*;/gim,
        Ne = /(?:^[^;\-\s}]+)?--[^;{}]*?:[^{};]*?(?:[;\n]|$)/gim,
        Oe = /(?:^[^;\-\s}]+)?--[^;{}]*?:[^{};]*?{[^}]*?}(?:[;\n]|$)?/gim,
        Pe = /@apply\s*\(?[^);]*\)?\s*(?:[;\n]|$)?/gim, Qe = /[^;:]*?:[^;]*?var\([^;]*\)(?:[;\n]|$)?/gim,
        Ie = /^@[^\s]*keyframes/, Ge = /\s+/g;
    var R = !(window.ShadyDOM && window.ShadyDOM.inUse), Re;
    ...
    window.ShadyCSS && void 0 !== window.ShadyCSS.nativeCss ? Re = window.ShadyCSS.nativeCss : window.ShadyCSS ? (Se(window.ShadyCSS), window.ShadyCSS = void 0) : Se(window.WebComponents && window.WebComponents.flags);
    var S = Re;
    var Te = /(?:^|[;\s{]\s*)(--[\w-]*?)\s*:\s*(?:((?:'(?:\\'|.)*?'|"(?:\\"|.)*?"|\([^)]*?\)|[^};{])+)|\{([^}]*)\}(?:(?=[;\s}])|$))/gi,
        Ue = /(?:^|\W+)@apply\s*\(?([^);\n]*)\)?/gi, Ve = /(--[\w-]+)\s*([:,;)]|$)/gi,
        We = /(animation\s*:)|(animation-name\s*:)/, Xe = /@media\s(.*)/, Ye = /\{[^}]*\}/g;
    var Ze = new Set;

    function $e(a, b) {
        if (!a) return "";
        "string" === typeof a && (a = Be(a));
        b && af(a, b);
        return Me(a, S)
    }

    function bf(a) {
        !a.__cssRules && a.textContent && (a.__cssRules = Be(a.textContent));
    ...
    function af(a, b, c, d) {
        if (a) {
            var e = !1, f = a.type;
            if (d && f === He) {
                var h = a.selector.match(Xe);
                h && (window.matchMedia(h[1]).matches || (e = !0))
            }
            f === Le ? b(a) : c && f === Je ? c(a) : f === Ke && (e = !0);
            if ((a = a.rules) && !e) {
                e = 0;
                f = a.length;
                for (var g; e < f && (g = a[e]); e++) af(g, b, c, d)
            }
        }
    }
    ...
    function kf(a, b, c, d) {
        b.nodeType === Node.ELEMENT_NODE && lf(b, c, d);
    ...
    function nf(a, b, c) {
        ...
        R || "shady" === e ? b = $e(b, c) : (a = V(a), b = of(d, b, a.is, a.P, c) + "\n\n");
        return b.trim()
    }
    ...
    function of(a, b, c, d, e) {
        ...
        return $e(b, function (b) {
            b.c || (b.selector = b.m = rf(a, b, a.b, c, f), b.c = !0);
            e && e(b, c, f)
        })
    }
    ...
    hf.prototype.b = function (a, b, c) {
        ...
        a = a.trim();
        var e = uf.test(a);
        e && (a = a.replace(uf, function (a, b, c) {
            return ":" + b + "(" + c.replace(/\s/g, "") + ")"
        }), a = tf(a));
        a = a.replace(vf, wf + " $1");
        a = a.replace(xf, function (a, e, g) {
            d || (a = yf(g, e, b, c), d = d || a.stop, e = a.Ka, g = a.value);
            return e + g
        });
        e && (a = tf(a));
        return a
    ...
    function yf(a, b, c, d) {
        var e = a.indexOf(zf);
        0 <= a.indexOf(wf) ? a = Af(a, d) : 0 !== e && (a = c ? Bf(a, c) : a);
        c = !1;
        0 <= e && (b = "", c = !0);
        if (c) {
            var f = !0;
    ...
    var uf = /:(nth[-\w]+)\(([^)]+)\)/, Kf = ":not(.style-scope)", sf = ",",
        xf = /(^|[\s>+~]+)((?:\[.+?\]|[^\s>+~=[])+)/g, Gf = /[[.:#*]/, wf = ":host", Jf = ":root", zf = "::slotted",
        vf = new RegExp("^(" + zf + ")"), Ff = /(:host)(?:\(((?:\([^)(]*\)|[^)(]*)+?)\))/,
        Cf = /(?:::slotted)(?:\(((?:\([^)(]*\)|[^)(]*)+?)\))/, Df = /(.*):dir\((?:(ltr|rtl))\)/, qf = ".", Ef = ":",
        mf = "class", Hf = "should_not_match", W = new hf;
    ...
    function Sf(a) {
        if (!a.i) {
            var b = {}, c = {};
            Tf(a, c) && (b.v = c, a.rules = null);
            b.cssText = a.parsedCssText.replace(Ye, "").replace(Te, "");
            a.i = b
        }
    }
    ...
    function Uf(a, b, c) {
        b && (b = 0 <= b.indexOf(";") ? Vf(a, b, c) : ff(b, function (b, e, f, h) {
            if (!e) return b + h;
            (e = Uf(a, c[e], c)) && "initial" !== e ? "apply-shim-inherit" === e && (e = "inherit") : e = Uf(a, c[f] || f, c) || f;
            return b + (e || "") + h
        }));
        return b && b.trim() || ""
    }
    ...
    function Vf(a, b, c) {
        ...
        for (var d = 0, e, f; d < b.length; d++) if (e = b[d]) {
            Ue.lastIndex = 0;
            if (f = Ue.exec(e)) e = Uf(a, c[f[1]], c); else if (f = e.indexOf(":"), -1 !== f) {
                var h = e.substring(f);
                h = h.trim();
                h = Uf(a, h, c) || h;
                e = e.substring(0, f) + h
    ...
    function Wf(a, b) {
        ...
        af(a, function (a) {
            ...
            b && a.i.v && e && Nf.call(b, e) && (Tf(a, c), a = a.index, e = parseInt(a / 32, 10), d[e] = (d[e] || 0) | 1 << a % 32)
        }, null, !0);
        return {v: c, key: d}
    }
    ...
    function Xf(a, b, c, d) {
        ...
        if (b.i.v) {
            ...
            if (h || g) c = e, g && (R && !b.m && (b.m = rf(W, b, W.b, a ? qf + a : "", e)), c = b.m || e), d({
                Xa: c,
                Qa: g,
                hb: h
            })
    ...
    function Zf(a, b, c, d) {
        ...
        return nf(b, e, function (b) {
            var e = "";
            b.i || Sf(b);
            b.i.cssText && (e = Vf(a, b.i.cssText, c));
            b.cssText = e;
            if (!R && !cf(b) && b.cssText) {
                var k = e = b.cssText;
                null == b.ra && (b.ra = We.test(e));
                if (b.ra) if (null == b.W) {
                    b.W = [];
    ...
    function bg(a, b) {
        ...
        a.textContent = $e(d, function (a) {
            ...
            a.i && a.i.cssText && (d = d.replace(Ne, "").replace(Oe, ""), a.cssText = Vf(c, d, b))
        })
    }
    ...
    var cg = new Qf;
    var dg = {}, eg = window.customElements;
    if (eg && !R) {
        var fg = eg.define;
        ...
        for (var b = 0; b < a.length; b++) {
            ...
            if (c.target !== document.documentElement && c.target !== document.head) for (var d = 0; d < c.addedNodes.length; d++) {
                ...
                if (e.nodeType === Node.ELEMENT_NODE) {
                    ...
                    h = g;
                    g = h.indexOf(W.a);
                    if ((h = -1 < g ? h[g + 1] : "") && f === e.ownerDocument) jf(e, h, !0); else if (f.nodeType === Node.DOCUMENT_FRAGMENT_NODE &&
    ...
    function rg(a) {
        ...
        a.qa || (a.qa = !0, og.then(function () {
            a._applyShimCurrentVersion = a._applyShimNextVersion;
            a.qa = !1
        }))
    };var sg = null, tg = window.HTMLImports && window.HTMLImports.whenReady || null, ug;
        ...
        if (!a.Ia) {
            ...
            for (var f = a.content.querySelectorAll("style"), h = 0; h < f.length; h++) {
                ...
                if (g.hasAttribute("shady-unscoped")) {
                    if (!R) {
                        var k = g.textContent;
                        Ze.has(k) || (Ze.add(k), k = g.cloneNode(!0), document.head.appendChild(k));
            ...
            d = [];
            S || (d = Rf(a._styleAst));
            if (!d.length || S) e = R ? a.content : null, b = dg[b], f = nf(c, a._styleAst), b = f.length ? df(f, c.is, e, b) : void 0, a.pa = b;
            a.Ha = d
        }
    };
    ...
    p.F = function () {
        ...
        if (this.b) {
            ...
            if (this.b.enqueued) {
                ...
                } else for (zg(this, this.c, this.h), b = 0; b < a.length; b++) (c = this.b.getStyleForCustomStyle(a[b])) && bg(c, this.h.B);
                this.b.enqueued = !1;
                this.s && !S && this.styleDocument()
            }
        }
    };
    p.styleElement = function (a, b) {
        ...
        if (S) {
            ...
            if (((k = ng[c]) || a === this.c) && k && k.pa && !qg(k)) {
                if (qg(k) || k._applyShimValidatingVersion !== k._applyShimNextVersion) xg(this), this.a && this.a.transformRules(k._styleAst, c), k.pa.textContent =
                    nf(a, d.w), rg(k);
                R && (c = a.shadowRoot) && (c.querySelector("style").textContent = nf(a, d.w));
                d.w = k._styleAst
            }
        } else if (zg(this, a, d), d.ja && d.ja.length) {
            c = d;
            k = V(a).is;
            d = (b = wg.fetch(k, c.B, c.ja)) ? b.styleElement : null;
            h = c.u;
            (g = b && b.u) || (g = this.L[k] = (this.L[k] || 0) + 1, g = k + "-" + g);
            c.u = g;
            g = c.u;
            e = cg;
            e = d ? d.textContent || "" : Zf(e, a, c.B, g);
            f = X(a);
            var l = f.a;
            l && !R && l !== d && (l._useCount--, 0 >= l._useCount && l.parentNode && l.parentNode.removeChild(l));
            R ? f.a ? (f.a.textContent = e, d = f.a) : e && (d = df(e, g, a.shadowRoot, f.b)) : d ? d.parentNode ||
                (Pf && -1 < e.indexOf("@media") && (d.textContent = e), ef(d, null, f.b)) : e && (d = df(e, g, null, f.b));
            d && (d._useCount = d._useCount || 0, f.a != d && d._useCount++, f.a = d);
            g = d;
            R || (d = c.u, f = e = a.getAttribute("class") || "", h && (f = e.replace(new RegExp("\\s*x-scope\\s*" + h + "\\s*", "g"), " ")), f += (f ? " " : "") + "x-scope " + d, e !== f && gf(a, f));
            b || wg.store(k, c.B, g, c.u)
        }
    };
    ...
    function zg(a, b, c) {
        ...
        var e = Yf(b, c.w);
        b = Wf(d.w, b).v;
        Object.assign(a, e.Oa, b, e.Wa);
        b = c.G;
        for (var f in b) if ((e = b[f]) || 0 === e) a[f] = e;
        f = cg;
        b = Object.getOwnPropertyNames(a);
        for (e = 0; e < b.length; e++) d = b[e], a[d] = Uf(f, a[d], a);
        c.B = a
    }
    ...
    p.ua = function (a) {
        ...
        af(c, function (a) {
            if (R) If(a); else {
                ...
                If(a);
                a.selector = a.m = rf(c, a, c.c, void 0, void 0)
            }
    ...
    Y.prototype.transformCustomStyleForDocument = Y.prototype.ua;
    ...
    window.ShadyCSS = {
        ...
        }, nativeCss: S, nativeShadow: R
    };
    Bg && (window.ShadyCSS.ApplyShim = Bg);
    Cg && (window.ShadyCSS.CustomStyleInterface = Cg);
    var Dg = window.customElements, Eg = window.HTMLImports, Fg = window.HTMLTemplateElement;
    window.WebComponents = window.WebComponents || {};
    if (Dg && Dg.polyfillWrapFlushCallback) {
        var Gg, Hg = function () {
            if (Gg) {
