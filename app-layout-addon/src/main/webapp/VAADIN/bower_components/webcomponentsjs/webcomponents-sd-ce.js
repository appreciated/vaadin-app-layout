...
*/
    ...
    r.ua = !(!Element.prototype.attachShadow || !Node.prototype.getRootNode);
    ...
    function Ca(a, b) {
        ...
        var c = a.__shady.G;
        return {
            ma: b, v: c, pa: a, takeRecords: function () {
    ...
    function Da(a) {
        var b = a && a.v;
        b && (b.M.delete(a.ma), b.M.size || (a.pa.__shady.G = null))
    }
    ...
    function qb(a) {
        if (a.__shady && void 0 !== a.__shady.$) for (var b = a.childNodes, c = 0, d = b.length, e; c < d && (e = b[c]); c++) qb(e);
    ...
    function wb(a) {
        if (a && a.nodeType) {
            a.__shady = a.__shady || {};
            var b = a.__shady.$;
            void 0 === b && (b = u(a) ? a : (b = a.parentNode) ? wb(b) : a, w.contains.call(document.documentElement, a) && (a.__shady.$ = b));
            return b
        }
    }
    ...
    var Gb = {
        get composed() {
            ...
            this.b || (this.b = Eb(this.__target, this.composed));
            return this.b
        }, get target() {
            return Fb(this.currentTarget, this.composedPath())
        }, get relatedTarget() {
            if (!this.R) return null;
            this.c || (this.c = Eb(this.R, !0));
            return Fb(this.currentTarget, this.c)
    ...
    function Lb(a) {
        ...
        for (c = 0; c < b.length; c++) {
            ...
            if (0 === c || f && f === e) if (Kb(a, d, "bubble"), d !== window && (e = d.getRootNode()), a.a) break
        }
    }
    ...
    function Nb(a, b, c) {
        if (b) {
            ...
            if ("function" === d || "object" === d) if ("object" !== d || b.handleEvent && "function" === typeof b.handleEvent) {
                ...
                b[Cb].push({node: this, type: a, capture: e, once: f, passive: h, Fa: k});
                Ib[a] ? (this.__handlers =
                    this.__handlers || {}, this.__handlers[a] = this.__handlers[a] || {
                    capture: [],
                    bubble: []
                }, this.__handlers[a][e ? "capture" : "bubble"].push(k)) : (this instanceof Window ? w.Da : w.addEventListener).call(this, a, k, c)
            }
        }
    }
    ...
    function Pb(a, b, c) {
        if (b) {
            ...
            var h = c && c.S || this, g = void 0;
            var k = null;
            try {
                k = b[Cb]
            } catch (l) {
            }
            k && (e = Mb(k, h, a, d, e, f), -1 < e && (g = k.splice(e, 1)[0].Fa, k.length || (b[Cb] = void 0)));
            (this instanceof Window ? w.Ea : w.removeEventListener).call(this, a, g || b, c);
    ...
    function D(a, b, c) {
        ...
        b.__shady = b.__shady || {};
        b.__shady.root = a;
        b.__shady.xa = "closed" !== a.oa ? a : null;
        a.K = !1;
        a.l = [];
        a.i = {};
        a.C = [];
    ...
    D.prototype._renderRoot = function () {
        ...
        for (var a = 0, b; a < this.l.length; a++) {
            ...
            b.__shady.D = [];
            if (b.__shady.aa = c) for (var d = 0; d < c.length; d++) {
                var e = c[d];
                e.__shady.W = e.__shady.assignedSlot;
        ...
        for (a = 0; a < this.l.length; a++) {
            ...
            if (c = b.__shady.aa) {
                for (d = 0; d < c.length; d++) c[d].__shady.W = null;
                b.__shady.aa = null;
                c.length > b.__shady.assignedNodes.length && (b.__shady.Y = !0)
            }
    ...
    function Zb(a, b, c) {
        ...
        d !== b.__shady.assignedSlot && b.__shady.assignedSlot && (b.__shady.assignedSlot.__shady.Y = !0)
    }
    ...
    function rb(a) {
        if (a.C.length) {
            ...
            if (c) for (var h in c) a.i[h] = vb(a.i[h]);
            a.C = []
        }
    }
    ...
    function L(a, b, c) {
        c = void 0 === c ? {} : c;
        var d = c.Ca || new Set, e = c.ga || function (b) {
            return vc(a, b)
        }, f = [];
        G(b, function (b) {
    ...
    function wc(a) {
        ...
        this.v = void 0;
        L(this.h, this.a);
        "loading" === this.a.readyState && (this.v = new MutationObserver(this.b.bind(this)), this.v.observe(this.a, {
            childList: !0,
            subtree: !0
        }))
    }
    ...
    wc.prototype.b = function (a) {
        ...
        for (b = 0; b < a.length; b++) for (var c = a[b].addedNodes, d = 0; d < c.length; d++) L(this.h, c[d])
    };
    ...
    M.prototype.define = function (a, b) {
        ...
        if (this.T) throw Error("A custom element is already being defined.");
        this.T = !0;
        try {
            var d = function (a) {
                var b = e[a];
    ...
    function Ac(a) {
        if (!1 !== a.J) {
            a.J = !1;
            for (var b = a.V, c = [], d = new Map, e = 0; e < b.length; e++) d.set(b[e].localName, []);
            L(a.h, document, {
                ga: function (b) {
                    if (void 0 === b.__CE_state) {
            ...
            for (e = 0; e < c.length; e++) vc(a.h, c[e]);
            for (; 0 < b.length;) {
                var f = b.shift();
                e = f.localName;
                f = d.get(f.localName);
                for (var h = 0; h < f.length; h++) vc(a.h, f[h]);
                (e = a.X.get(e)) && zc(e)
            }
        }
    }
    ...
    M.prototype.a = function (a) {
        ...
        b = new yc;
        this.X.set(a, b);
        this.h.a.get(a) && !this.V.some(function (b) {
    ...
    M.prototype.whenDefined = M.prototype.a;
    M.prototype.polyfillWrapFlushCallback = M.prototype.b;
    ...
    function gd() {
        ...
        window.HTMLElement = function () {
            function b() {
                var b = this.constructor, d = a.A.get(b);
...
*/
    ...
    Td.prototype.b = function (a, b, c) {
        ...
        a = a.replace(he, function (a, e, g) {
            d || (a = ie(g, e, b, c), d = d || a.stop, e = a.sa, g = a.value);
            return e + g
        });
        e && (a = de(a));
        return a
    ...
    function Fe(a, b) {
        ...
        S(a, function (a) {
            ...
            b && a.g.o && e && xe.call(b, e) && (Ce(a, c), a = a.index, e = parseInt(a / 32, 10), d[e] = (d[e] || 0) | 1 << a % 32)
        }, null, !0);
        return {o: c, key: d}
    }
    ...
    function Ie(a, b, c, d) {
        ...
        return Yd(b, e, function (b) {
            var e = "";
            b.g || Be(b);
            b.g.cssText && (e = Ee(a, b.g.cssText, c));
            b.cssText = e;
            if (!P && !Od(b) && b.cssText) {
                var k = e = b.cssText;
                null == b.da && (b.da = Jd.test(e));
                if (b.da) if (null == b.N) {
                    b.N = [];
    ...
    function Le(a, b) {
        ...
        a.textContent = R(d, function (a) {
            ...
            a.g && a.g.cssText && (d = d.replace(Ad, "").replace(Bd, ""), a.cssText = Ee(c, d, b))
        })
    }
    ...
    n.prepareTemplate = function (a, b, c) {
        if (!a.b) {
            ...
            d = [];
            Q || (d = Ae(a._styleAst));
            if (!d.length || Q) e = P ? a.content : null, b = Ne[b], f = Yd(c, a._styleAst), b = f.length ? Pd(f, c.is, e, b) : void 0, a.ba = b;
            a.qa = d
        }
    };
    ...
    n.w = function () {
        ...
        if (this.b) {
            ...
            if (this.b.enqueued) {
                ...
                } else for (jf(this, this.c, this.f), b = 0; b < a.length; b++) (c = this.b.getStyleForCustomStyle(a[b])) && Le(c, this.f.u);
                this.b.enqueued = !1;
                this.A && !Q && this.styleDocument()
            }
        }
    };
    n.styleElement = function (a, b) {
        ...
        if (Q) {
            ...
            if (((k = Xe[c]) || a === this.c) && k && k.ba && !$e(k)) {
                if ($e(k) || k._applyShimValidatingVersion !== k._applyShimNextVersion) gf(this), this.a && this.a.transformRules(k._styleAst, c), k.ba.textContent =
                    Yd(a, d.s), af(k);
            ...
            c = d;
            k = U(a).is;
            d = (b = ff.fetch(k, c.u, c.Z)) ? b.styleElement : null;
            h = c.m;
            (g = b && b.m) || (g = this.ca[k] = (this.ca[k] || 0) + 1, g = k + "-" + g);
            c.m = g;
            g = c.m;
            e = Me;
            e = d ? d.textContent || "" : Ie(e, a, c.u, g);
            f = W(a);
            var l = f.a;
            l && !P && l !== d && (l._useCount--, 0 >= l._useCount && l.parentNode && l.parentNode.removeChild(l));
            P ? f.a ? (f.a.textContent = e, d = f.a) : e && (d = Pd(e, g, a.shadowRoot, f.b)) : d ? d.parentNode || (ye &&
            -1 < e.indexOf("@media") && (d.textContent = e), Qd(d, null, f.b)) : e && (d = Pd(e, g, null, f.b));
    ...
    Y.prototype._styleInfoForNode = Y.prototype.ra;
    Y.prototype.transformCustomStyleForDocument = Y.prototype.fa;
    Y.prototype.getStyleAst = Y.prototype.ta;
    Y.prototype.styleAstToString = Y.prototype.Ba;
    Y.prototype.flushCustomStyles = Y.prototype.w;
