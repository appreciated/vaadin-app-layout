package com.github.appreciated.basic.test.ui.annotated;
...
public class NoNavigatorUI extends UI {
    ...
    @VaadinServletConfiguration(productionMode = false, ui = NoNavigatorUI.class)
