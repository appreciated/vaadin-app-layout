...
import com.github.appreciated.app.layout.test.ui.annotated.BasicAnnotatedUI;
...
@SpringBootTest(classes = BasicAnnotatedUI.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
