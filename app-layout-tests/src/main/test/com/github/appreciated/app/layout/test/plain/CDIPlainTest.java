...
import com.github.appreciated.app.layout.test.ui.plain.CdiPlainUI;
import com.github.appreciated.app.layout.test.view.plain.cdi.*;
...
@SpringBootTest(
        classes = {CdiPlainUI.class, View1.class, View2.class, View3.class, View4.class, View5.class, View6.class},
        webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT
)
public class CDIPlainTest {
