...
import com.github.appreciated.app.layout.test.ui.plain.BasicPlainUI;
...
@SpringBootTest(classes = BasicPlainUI.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
public class BasicPlainTest {
