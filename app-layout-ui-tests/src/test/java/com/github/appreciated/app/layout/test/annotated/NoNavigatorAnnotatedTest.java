...
import com.github.appreciated.app.layout.test.ui.annotated.NoNavigatorAnnotatedUI;
...
@SpringBootTest(classes = NoNavigatorAnnotatedUI.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
public class NoNavigatorAnnotatedTest {
