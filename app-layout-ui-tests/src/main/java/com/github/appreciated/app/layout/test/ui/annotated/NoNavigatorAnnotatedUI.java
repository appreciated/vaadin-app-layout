...
public class NoNavigatorAnnotatedUI extends UI {
    ...
    public void init(VaadinRequest request) {
        setContent(AppLayout.getNoNavigatorBuilder(Behaviour.LEFT_RESPONSIVE_HYBRID)
                .withTitle("App Layout No Navigator Annotated Test")
    ...
    @VaadinServletConfiguration(productionMode = false, ui = NoNavigatorAnnotatedUI.class)
