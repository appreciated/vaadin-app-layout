...
public class NoNavigatorPlainUI extends UI {
    ...
    public void init(VaadinRequest request) {
        setContent(AppLayout.getNoNavigatorBuilder(Behaviour.LEFT_RESPONSIVE_HYBRID)
                .withTitle("App Layout No Navigator Plain Test")
    ...
    @VaadinServletConfiguration(productionMode = false, ui = NoNavigatorPlainUI.class)
