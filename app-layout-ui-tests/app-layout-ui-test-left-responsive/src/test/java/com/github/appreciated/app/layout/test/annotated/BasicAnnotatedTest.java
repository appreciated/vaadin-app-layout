...
@SpringBootTest(classes = BasicMain.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
public class BasicAnnotatedTest {
    ...
    public WebElement getShadowRoot(String element) {
        return (WebElement) ((JavascriptExecutor) driver)
                .executeScript("return document.getElementsByTagName(\"" + element + "\")[0].shadowRoot.childNodes[2]");
    }
    ...
    public WebElement findByTagName(WebElement element, String tag, int i) {
        return (WebElement) ((JavascriptExecutor) driver)
                .executeScript("return arguments[0].getElementsByTagName(\"" + tag + "\")[" + i + "]", element);
    }
    ...
    public WebElement findByClassName(WebElement element, String className, int i) {
        WebElement root = (WebElement) ((JavascriptExecutor) driver)
                .executeScript("return arguments[0].getElementsByClassName(\"" + className + "\")[" + i + "]", element);
        return root;
    }
